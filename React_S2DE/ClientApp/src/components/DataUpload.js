        ...
        return (
            <Tab.Container  defaultActiveKey="CTQS" style={{}}>
                <Row style={{ marginLeft: "0px", marginTop: "-15px", marginRight: "-40px" }}>
                    <Col className="m-3" xs={10} s={10} md={3} lg={3} xl={2} style={{ backgroundColor: '#6497b1', borderRadius: '5px' }}>
                    ...
                    <Col xs={10} s={10} md={7} lg={8} xl={9} style={{ backgroundColor: '#6497b1', borderRadius: '5px', marginBottom: '1rem', marginTop: '1rem' }}>
                        <Tab.Content>
